        ...
        <div id="content">
          ...
          <div className="card shadow mb-4">
            ...
            <div className="card-body">
              <p>
                Estoy emocionado de tenerte aquí y compartir contigo una muestra
                de nuestro trabajo y habilidades. nuestro portafolio es un lugar donde
                podrás conocer más sobre los demas, explorar proyectos pasados y
                descubrir lo que pueden ofrecer las demas personas. Siéntete libre de navegar por
                las distintas secciones, desde proyectos destacados hasta mis estudios. Espero que encuentres la información
                que estás buscando y que disfrutes de tu visita. Aqui podras subir tus proyectos y estudio que quieras. Gracias por
                tomarte el tiempo para conocerme a través de mi portafolio web.
                ¡Espero que sea el comienzo de una conexión significativa y que
                podamos colaborar en el futuro!
              </p>
            </div>
          </div>
        </div>
